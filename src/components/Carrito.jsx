...
const Carrito = ({ compras, onComprar, onEliminarProducto, cart }) => {
  ...
  return (
    <Chakra.Box >
      ...
      <Chakra.SimpleGrid  minChildWidth='120px' spacing='40px ' bgGradient="linear(to bottom, #FF5733, #F2C94C, #B76840)" templateColumns={{ base: '1fr', sm: 'repeat(2, 1fr)', md: 'repeat(3, 1fr)' }} gap={2} justifyContent="center" >
        {cart?.map((producto) => (
