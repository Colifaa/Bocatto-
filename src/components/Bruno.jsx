...
<Chakra.VStack align="center" spacing={50} justifyContent="flex-end">
  <Admin />

  <Chakra.Button fontSize={['xl', '2xl', '3xl']} colorScheme="teal" onClick={handleGoToHome}>
    Ir al Home
  </Chakra.Button>
  {isLoggedIn ? (
    <Chakra.Button fontSize={['xl', '2xl', '3xl']} colorScheme="teal" onClick={handleLogout}>
      Cerrar sesión
    </Chakra.Button>
  ) : (
    <>
      <Chakra.Button fontSize={['xl', '2xl', '3xl']} colorScheme="teal" onClick={handleOpenForm}>
        Iniciar sesión
      </Chakra.Button>
